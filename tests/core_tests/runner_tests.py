...
class MyTestCase(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(my_test_runner.input_file, INPUT_FILE_PATH)  # add assertion here
    ...
    def test_read_instructions(self):
        ...
        number_of_epochs = my_test_runner.instructions["Train"]["hyperparameters"]["epochs"]
    ...
    def test_plan_training(self):
        ...
        new_test_runner.instructions['Train'] = {'dataset' : 'coco8-seg.yaml',
                                                 'hyperparameters' : {'seed' : 16
                                                                      }
                                                 }
        new_test_runner.plan_training()
        expected_instructions = {'dataset' : 'coco8-seg.yaml',
                                 'settings' : {'model_architecture' : 'yolo11n-seg',
                                               'model_path' : '.',
                                               'model_name' : f'model_created_{datetime.
        ...
        self.assertEqual(expected_instructions, new_test_runner.instructions['Train'])
    ...
    def test_plan_usage(self):
        ...
        self.assertEqual(expected_instructions, new_test_runner.instructions['Usage'])
