...
class MyTestCase(unittest.TestCase):
    ...
    def test_init(self):
        """Test that the Runner initialises properly."""
    ...
    def test_read_instructions(self):
        """Test that the instructions are correctly read."""
    ...
    def test_check_instructions(self):
        """Test that the instructions are correctly checked."""
        my_test_runner.check_instructions()

    def test_plan_training(self):
        """Test that the training instructions are set correctly."""
    ...
    def test_plan_usage(self):
        """Test that the usage instructions are set correctly."""
        new_test_runner = Runner()
