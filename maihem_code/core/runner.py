"""A class to perform the various actions from the instruction file and run the program"""
...
class Runner:
    ...
    check_instructions()
        Checks what instructions are given and that the file paths and lesion names exist
    plan_training()
        Formats the training instructions to be complete and readable by the program
    plan_usage()
        Formats the usage instructions to be complete and readable by the program
    execute_training()
    ...
    def check_instructions(self):
        ...
        if 'Usage' in self.instructions.keys():
            ...
            Input.check_lesion_names(self.instructions['Usage']['parameters']['lesion_names'],
